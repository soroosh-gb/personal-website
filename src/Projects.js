    ...
    render(){
        return  <>
                    <div className="Project-card">
                         ...
                         <a href="https://youtu.be/KuI0VSqFgLU"><FontAwesomeIcon icon={faYoutube} size="4x" /></a>
                    ...
                    <div className="Project-card">
                        ...
                        <a href="https://youtu.be/gob40NAEFI0" ><FontAwesomeIcon icon={faYoutube} size="4x" /></a>
                    ...
                    <div className="Project-card">
                        ...
                        <a href="https://youtu.be/4ijTMj9LQdI"><FontAwesomeIcon icon={faYoutube} size="4x" /></a>
                    </div>
                </>
    }
}
